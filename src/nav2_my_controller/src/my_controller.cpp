  ...
  nav2_core::GoalChecker * goal_checker)
{
  ...
  [[maybe_unused]] const auto &unused_velocity_ = velocity;
  [[maybe_unused]] const auto &unused_goal_checker_ = goal_checker;
...
void setSpeedLimit(const double & speed_limit, const bool & percentage) {
  [[maybe_unused]] const auto &speed_limit_ = speed_limit;
  [[maybe_unused]] const auto &percentage_ = percentage;
}

nav_msgs::msg::Path
MyController::transformGlobalPlan(
  const geometry_msgs::msg::PoseStamped & pose)
{
...
bool MyController::transformPose(
...
PLUGINLIB_EXPORT_CLASS(nav2_my_controller::MyController, nav2_core::Controller)
